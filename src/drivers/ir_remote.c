...
static uint32_t ir_message_raw = 0;
...
static void isr_pulse(void)
{
    ...
    if (!is_valid_pulse(pulse_count, timer_ms)) {
        ...
        ir_message_raw <<= 1;
        ir_message_raw += (timer_ms >= 2) ? 1 : 0;
    }

    if (is_message_pulse(pulse_count)) {
        uint8_t cmd = (uint8_t)((ir_message_raw >> 16) & 0xFF); // Extract command byte
        ring_buffer_put(&ir_cmd_buffer, cmd);
    }
...
const char *ir_remote_cmd_to_string(ir_command_e cmd)
{
    switch (cmd) {
    case IR_CMD_0: return "0";
    case IR_CMD_1: return "1";
    case IR_CMD_2: return "2";
    case IR_CMD_3: return "3";
    case IR_CMD_4: return "4";
    case IR_CMD_5: return "5";
    case IR_CMD_6: return "6";
    case IR_CMD_7: return "7";
    case IR_CMD_8: return "8";
    case IR_CMD_9: return "9";
    case IR_CMD_STAR: return "STAR";
    case IR_CMD_HASH: return "HASH";
